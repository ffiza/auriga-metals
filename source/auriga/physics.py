class Physics:
    ...
    def __init__(self) -> None:
        self.solar_metallicity = 0.0127
        self.gravitational_constant = 4.3E-3
        self.proton_mass = 1.67262192369
        self.solar_mass = 1.98847
        self.critical_temperature = 2E4
        self.star_forming_density = 0.13

        # Metals
        self.metals = ['H', 'He', 'C', 'N', 'O', 'Ne', 'Mg', 'Si', 'Fe']
        # Asplund+2009 (Table 5)
        self.solar_abundances = {'H': 12, 'He': 10.98, 'C': 8.47,
                                 'N': 7.87, 'O': 8.73, 'Ne': 7.97,
                                 'Mg': 7.64, 'Si': 7.55, 'Fe': 7.54}
        self.atomic_numbers = {'H': 1, 'He': 4, 'C': 12,
                               'N': 14, 'O': 16, 'Ne': 20,
                               'Mg': 24, 'Si': 28, 'Fe': 56}
